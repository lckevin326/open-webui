...
async def speech(request: Request, user=Depends(get_verified_user)):
    ...
    if request.app.state.config.TTS_ENGINE == 'openai':
        ...
        try:
            ...
            status_code = 500
            detail = f'MedMapAgent: Server Connection Error'
        ...
        try:
            ...
            raise HTTPException(
                ...
                detail=detail if detail else 'MedMapAgent: Server Connection Error',
            )
        ...
        try:
            ...
            status_code = 500
            detail = 'MedMapAgent: Server Connection Error'
...
def transcription_handler(request, file_path, metadata, user=None):
    ...
    if request.app.state.config.STT_ENGINE == '':
        ...
        try:
            ...
            raise Exception(detail if detail else 'MedMapAgent: Server Connection Error')
